...
account_sid = 'AC08060fb2568dd53678ff3a6507c28b7f'
auth_token = '7f41d84189d5ad55b9f2d56e8a447e17'
...
def getGGA(lines):
    latlng = getLatLng(lines[2], lines[4])
    latlong = latlng[0] + lines[3] + "," + latlng[1] + lines[5]
...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            lines = line.split(",")
            if lines[0] == "GPGGA":
                coordinates = getGGA(lines)
                print(coordinates)
                if coordinates:
                    break
                    
        message = client.messages.create(
                     body="http://www.google.com/maps/place/" + coordinates,
                     from_='+16473701746',
                     to='+16475469571'
                 )
